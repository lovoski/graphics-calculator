...
public class CalculateModel {
    ...
    public CalculateModel(String input, String ZBL, String YBL, TransformModel T_model, int color, String CalculateMode) {
        this.ZBL = ZBL;
        this.YBL = YBL;
        this.input = judgeType(input);
        this.T_model = T_model;
        ...
        this.dorm_P = T_model.dorm_P;
        this.range_P = T_model.range_P;
        this.testMode = CalculateMode.equals("SLOW CORE")?3:2;
        a = new double[3000][3000];
        initializeSet();
        breakInput();
        processInputs();
    ...
    private static final double ji = 0.98;
